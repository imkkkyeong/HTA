...
INSERT INTO SAMPLE_BOOKS
VALUES(16, '혼공자', '나나나', 10000, 22, SYSDATE);
...
-- 도서테이블에서 책번호가 12인 책의 가격을 10% 할인하고, 재고수량을 1 감소 시킨다.
UPDATE SAMPLE_BOOKS
SET
...
-- 도서테이블에서 책제목이  '자바의 정석'인 책정보를 삭제하기
DELETE FROM SAMPLE_BOOKS
WHERE BOOK_NAME = '자바의 정석';
