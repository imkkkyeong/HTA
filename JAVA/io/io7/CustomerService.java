...
public class CustomerService {
    ...
    /**
     * 신규 고객 정보를 전달받아서 등록시킨다 업무로직 - 고객번호로 고객정보를 조회한다. 고객정보가 존재하면 예외를 발생시킨다 - 고객아이디로 고객정보를 조회한다. 고객정보가 존재하면 예외를 발생시킨다 -
    ...
    public void changePassword(int no, String password, String newPassword) {
        ...
        if (password.equals(newPassword)) {
            throw new ShopException("이번비밀번호와 같은 비밀번호로 지정할 수 없습니다.");
        }
